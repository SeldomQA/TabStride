...
//! * frames are decoded as [`tabstride_protocol::Frame::Request`] and dispatched
...
use tabstride_protocol::tools::{ReturnFailure, WaitMsParams, WaitMsResult};
...
mod tests {
    use super::*;
    use tabstride_protocol::{Frame, Method, RequestFrame};
