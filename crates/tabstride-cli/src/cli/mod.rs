...
#[command(
    name = "tabstride",
    version,
    about = "tabstride — drive your browser from AI agents"
)]
pub struct Cli {
    #[command(flatten)]
...
pub enum Command {
    ...
    /// Install the tabstride agent skill into local agent harnesses.
    #[command(name = "install-skill")]
    InstallSkill(InstallSkillArgs),

    /// Check for and install tabstride CLI updates.
    Update(UpdateArgs),
