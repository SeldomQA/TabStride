...
/// `std::io::stderr()`.
///
/// Examples: `tabstride session start` writes the connected-browsers table
...
/// would emit to stderr into a string. Used by `tabstride session start`'s
