//! `tabstride navigate` + `tabstride navigate-back / -forward` + `tabstride reload` (M7
...
//! emits the full tabstride-protocol payload.
...
struct OwnedHistoryView {
    ...
    dialogs: Vec<tabstride_protocol::tools::JavaScriptDialogInfo>,
}
