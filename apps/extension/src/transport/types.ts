// Wire-protocol shapes mirroring tabstride-protocol (see crates/tabstride-protocol/schema/*.json). The
...
// --------------------------------------------------------------------------
// M6 tool payloads — mirror tabstride-protocol (crates/tabstride-protocol/src/tools/*.rs)
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// M7 tool payloads — navigation (mirror tabstride-protocol)
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// M7 tool payloads — interaction (mirror tabstride-protocol)
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// Human-in-loop payloads — request_help (mirror tabstride-protocol)
// --------------------------------------------------------------------------
