...
// `__TABSTRIDE_EXT_VERSION__` define the production build will inline (review
...
export default defineConfig({
  ...
  define: {
    __TABSTRIDE_EXT_VERSION__: JSON.stringify(pkg.version),
  ...
  resolve: {
    alias: {
      ...
      "@tabstride/i18n/react": path.resolve(__dirname, "../../packages/i18n/src/react.tsx"),
      "@tabstride/i18n": path.resolve(__dirname, "../../packages/i18n/src/index.ts"),
    },
  },
});
