# tabstride — Install Guide for AI Agents

You are an AI agent setting up tabstride for the user. Done = `tabstride doctor`
...
If opening the page fails, give the user the same link. Then run `tabstride doctor`
