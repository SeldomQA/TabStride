#!/usr/bin/env node
/**
 * Render version.json for tabstride CLI GitHub releases (auto-update manifest).
 *
 * Usage:
 *   node scripts/render-version-json.mjs \
 *     --version 0.1.5 \
 *     --repo Tencent/TabStride \
...
function assetFilename(platformKey, triple) {
  if (platformKey === "windows-x64") {
    return `tabstride-v${version}-${triple}.zip`;
  }
  return `tabstride-v${version}-${triple}.tar.gz`;
}
